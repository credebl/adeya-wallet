...
const translation = {
  ...
  CameraDisclosure: {
    ...
    ToContinueUsing:
      'To continue using the ADEYA Wallet scan feature, please allow camera permissions in the settings.',
    Continue: 'Continue',
  ...
  Biometry: {
    ...
    EnabledText2:
      'Because of this, your ADEYA wallet may be accessed using any fingerprint or face data you upload to this phone. Make sure you are the only one who can access your wallet.',
  ...
  CredentialDetails: {
    ...
    CredentialRevokedMessageBody:
      'This credential may no longer work for some proof requests. You will need to update the credential with the issuer.',
  ...
  NameWallet: {
    ...
    CharCountDescription:
      "You've exceeded the maximum character count of 25 characters. Please reduce your character count.",
  ...
  NetInfo: {
    ...
    NoInternetConnectionMessage:
      "You're unable to access services using ADEYA or receive credentials until you're back online.\n\nPlease check your internet connection.",
