      ...
      <View style={style.screenContainer}>
        <View style={style.contentContainer}>
          <Text style={[TextTheme.normal, { alignSelf: 'center' }]}>
            <Text style={{ fontWeight: 'bold', justifyContent: 'center' }}>{t('PINCreate.RememberPIN')}</Text>
          </Text>
          <Text style={[TextTheme.normal, { marginBottom: 16, alignSelf: 'center' }]}>
            <Text>{t('PINCreate.PINDisclaimer')}</Text>
          </Text>
