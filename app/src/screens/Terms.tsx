    ...
    <SafeAreaView edges={['left', 'right', 'bottom']}>
      <ScrollView style={[style.container]}>
        ...
        <Text style={[style.bodyText, { marginTop: 20 }]}>
          The ADEYA Wallet App (the “Licensed Application”) allows you (“You” or “you”) to store your verifiable
          ...
          and/or use the ADEYA Wallet App. This EULA is a legal agreement between you, as the end user of the Licensed
        ...
        <View style={style.paragraph}>
          ...
          <Text style={[style.bodyText]}>
            ...
            the Licensed Application, should be directed to: Product Owner, ADEYA Wallet, ditrust@gov.bc.ca, 4000 Seymour
        ...
        <View style={style.paragraph}>
          ...
          <Text style={[style.bodyText]}>
            ...
            <Text style={[style.link]} onPress={useCallback(() => openLink(digitalWalletPrivacyUrl), [])}>
              ADEYA Wallet App Privacy Policy
            </Text>{' '}
