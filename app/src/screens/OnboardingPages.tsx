        ...
        <ImageBackground source={require('../assets/img/Onbording-image.svg')}>
          <Svg width="343" height="245" viewBox="0 0 380 262" fill="none">
            ...
            <Image
              ...
              style={{ width: 81, height: 82, flexShrink: 0, position: 'absolute', right: 100, top: 100, left: 170 }}
            />
            <Path
            ...
            <Path
              opacity="0.8"
              d="M12.2802 135L16 138.636L7.43966 146.997L16 155.364L12.2802 159L3.71983 150.633L0 146.997L3.71983 143.362L12.2802 135Z"
              fill="#474747"
            />
          </Svg>
        </ImageBackground>
