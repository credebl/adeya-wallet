...
const translation = {
  ...
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "To continue using the ADEYA Wallet scan feature, please allow camera permissions. (FR)",
    "Allow": "Allow (FR)",
  ...
  "Tour": {
    "GuideTitle": "Welcome to ADEYA Wallet (FR)",
    "WouldYouLike": "Would you like some guidance on how to use ADEYA Wallet? (FR)",
  ...
  "Settings": {
    ...
    "HelpUsingBCWallet": "Help using ADEYA Wallet (FR)",
  ...
  "Tips": {
    ...
    "Tip1": "For extra security, ADEYA Wallet locks the app after 5 minutes of inactivity (FR)",
