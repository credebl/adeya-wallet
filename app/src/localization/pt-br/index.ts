...
const translation = {
  ...
  "Terms": {
    ...
    "IAgree": "Eu Concordo",
    "Attestation": " Li, compreendi e aceito os termos e condições.",
  },
  "Error": {
  ...
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "To continue using the ADEYA Wallet scan feature, please allow camera permissions. (PT-BR)",
    "Allow": "Allow (PT-BR)",
  ...
  "NetInfo": {
    ...
    "NoInternetConnectionMessage": "You're unable to access services using ADEYA Wallet or receive credentials until you're back online.\n\nPlease check your internet connection. (PT-BR)",
  },
  "Tour": {
    "GuideTitle": "Welcome to ADEYA Wallet (PT-BR)",
    "WouldYouLike": "Would you like some guidance on how to use ADEYA Wallet? (PT-BR)",
  ...
  "Settings": {
    ...
    "HelpUsingBCWallet": "Help using ADEYA Wallet (PT-BR)",
  ...
  "Tips": {
    ...
    "Tip1": "For extra security, ADEYA Wallet locks the app after 5 minutes of inactivity (PT-BR)",
