...
Next, install the npm modules needed to build and test ADEYA Wallet from the root of the repository:

```sh
# Install ADEYA Wallet project dependencies (package.json) from the root of the cloned repository
npm install --force
```
