...
import { StatusBar, Keyboard, StyleSheet, Text, View, DeviceEventEmitter } from 'react-native'
import { widthPercentageToDP as wp, heightPercentageToDP as hp } from 'react-native-responsive-screen'

import ButtonLoading from '../components/animated/ButtonLoading'
import Button, { ButtonType } from '../components/buttons/Button'
import { AdeyaLogoSecondary } from '../components/common/AdeyaLogoSecondary'
      ...
      <View style={style.screenContainer}>
        <View style={style.contentContainer}>
          <View style={{ alignSelf: 'center', marginBottom: 50 }}>
            <AdeyaLogoSecondary
              source={require('../assets/img/adeya-logo-secondary.png')}
              style={style.header}
              resizeMode="contain"
            />
          </View>
